...
olympics_count = olympics.groupby(["sport", "medal"], observed=True).size().reset_index(name = "n")
...
# Update the layout to match the original chart
fig.update_layout(
    yaxis_title="",
    xaxis_title="",
    barmode="stack",
...
fig.update_layout(
    ...
    xaxis=dict(tickmode="linear", dtick=8),  
    showlegend=False
)
```
:::
